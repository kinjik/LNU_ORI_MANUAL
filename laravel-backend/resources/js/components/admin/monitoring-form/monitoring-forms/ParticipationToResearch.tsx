...
const ParticipationToResearch = ({
  ...
  const handleClick = async () => {
    ...
    const updateVariables: UpdateMonitoringFormVariables = {
      id: participation.researchmonitoringform_id,
    ...
    <>
      <div className="flex w-auto flex-col justify-center">
        ...
        <input
          ...
          value={participation.research_title}
          disabled
        ...
        <input
          id="fundSource"
          value={participation.fund_source_nature}
          disabled
          className="w-auto text-ellipsis border-b border-b-slate-600 py-1 ps-1 text-start text-sm capitalize"
        />
