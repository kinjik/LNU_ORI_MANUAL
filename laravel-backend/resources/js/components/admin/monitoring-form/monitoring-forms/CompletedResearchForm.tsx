...
const CompletedResearchForm = ({
  ...
  const handleClick = async () => {
    ...
    const updateVariables: UpdateMonitoringFormVariables = {
      id: completedresearchprod.researchmonitoringform_id,
    ...
    <>
      <div className="flex w-auto flex-col justify-center">
        ...
        <input
          ...
          value={completedresearchprod.research.title}
          disabled
        ...
        <input
          id="date"
          value={parseDate(completedresearchprod.date_completed)}
          disabled
          className="w-auto text-ellipsis border-b border-b-slate-600 bg-white py-1 ps-1 text-start text-sm capitalize"
        />
        ...
        <input
          id="organizer"
          value={completedresearchprod.nature_fund_source}
          disabled
          className="w-auto text-ellipsis border-b border-b-slate-600 bg-white py-1 ps-1 text-start text-sm capitalize"
        />
